...
public class CommentApplicationService {
    ...
    @Transactional public void delete(Long userId, boolean admin, Long id) { CommentJpaEntity c=get(id); if(!admin&&!c.getUserId().equals(userId)) throw new CoreException(ErrorType.FORBIDDEN,"comment access denied."); c.delete(); }
