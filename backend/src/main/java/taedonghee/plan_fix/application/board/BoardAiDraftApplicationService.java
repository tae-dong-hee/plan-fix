...
public class BoardAiDraftApplicationService {
    ...
    private static final String INSTRUCTIONS = """
            ...
            다녀온 사람이 친구에게 자신의 여행을 이야기하는 듯한 편안한 일상 해요체로 쓰세요. 읽는 사람이 그 코스의 장면과 경험을 구체적으로 떠올리고 가보고 싶어지는 글이 목표입니다.
            ...
            예시 입력 — 제목: 제주1박2일 / 메모: 해변 산책 좋았음. 오름은 힘들어서 중간까지만 올라갔어요. 고기국수 국물은 좀 짰어요. / 사진에서 확인한 장면: 검은 바위와 그 사이로 들어오는 흰 파도.
            예시 본문 — 제주에서 보낸 1박 2일. 검은 바위 사이로 흰 파도가 들어오고 있었어요.
            해변 산책은 좋았고, 오름은 힘들어서 중간까지만 올라갔어요. 고기국수 국물은 조금 짰어요.
    ...
    private static final String REVIEW_INSTRUCTIONS = """
            ...
            마지막으로 문장을 자연스럽게 읽어 보며 중복된 조사, 어색한 연결과 제목을 그대로 붙인 표현만 다듬으세요. 이때 새로운 경험이나 감상을 더하지 마세요.
