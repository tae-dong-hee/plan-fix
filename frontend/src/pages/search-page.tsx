...
export default function SearchPage() {
  ...
  return <div className="min-h-screen bg-muted/20 pb-24"><AppNav /><main className="mx-auto max-w-6xl px-4 pt-8 sm:px-6">
