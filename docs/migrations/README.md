...
## 안보전시관 대표사진 보완 (2026-09-19)

`2026-09-19-backfill-security-exhibition-photo.sql`은 통일공원 갤러리에서 건물 표기·주소·전화·좌표를 검수한 사진을 강릉통일공원안보전시관(534)의 빈 대표사진에 연결한다. 프런트의 출처 카탈로그를 먼저 배포하고 대상534와 원본420의 장소·관광정보·갤러리를 백업한 뒤 적용한다. 신원이나 사진 상태가 바뀌면 전체 롤백하며 원본420의 사진은 변경하지 않는다. [검수 근거](../assets/remaining-spot-photos.md)를 확인한다.
